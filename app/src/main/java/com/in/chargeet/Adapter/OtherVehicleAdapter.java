...
public class OtherVehicleAdapter extends RecyclerView.Adapter<OtherVehicleAdapter.ViewHolder> {

    List<OtherVehicleModel.OtherVehicle> list;
    Context context;
    Click click;
    ...
    public OtherVehicleAdapter(List<OtherVehicleModel.OtherVehicle> list, Context context, Click click) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.other_vehicle_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        OtherVehicleModel.OtherVehicle model = list.get(position);
